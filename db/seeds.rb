...
# so that it can be executed at any point in every environment. The data can then be
# loaded with the bin/rails db:seed command (or created alongside the database with
# db:setup).
#
# Example:
#
