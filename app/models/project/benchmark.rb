      ...
      executions: [
          {
            ...
            command: [
              ...
              "--python", "/tmp/scripts/sample.py",
              "-o", "/tmp/sample-frames/sample-",
              "-f", "$frame",
              "--",
              "--resolution-width", sample_settings["resolution_x"].to_s,
              "--resolution-height", sample_settings["resolution_y"].to_s,
              "--cycles-samples", sample_settings["sampling_max_samples"].to_s,
