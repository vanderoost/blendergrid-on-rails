...
# See the ActiveSupport::ParameterFilter documentation for supported notations and
# behaviors.
Rails.application.config.filter_parameters += [ :passw, :email, :secret, :token, :_key,
